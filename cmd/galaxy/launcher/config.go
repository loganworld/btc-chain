...
import (
	...
	"github.com/galaxy-digital/lachesis-base/abft"
	"github.com/galaxy-digital/lachesis-base/hash"
	"github.com/galaxy-digital/lachesis-base/utils/cachescale"
	"github.com/naoina/toml"
	"gopkg.in/urfave/cli.v1"

	"github.com/galaxy-digital/galaxychain-chain/evmcore"

	galaxy "github.com/galaxy-digital/galaxychain-chain/galaxy"
	"github.com/galaxy-digital/galaxychain-chain/galaxy/genesisstore"
	"github.com/galaxy-digital/galaxychain-chain/gossip"
	"github.com/galaxy-digital/galaxychain-chain/gossip/gasprice"
	"github.com/galaxy-digital/galaxychain-chain/integration"
	"github.com/galaxy-digital/galaxychain-chain/integration/makegenesis"
	futils "github.com/galaxy-digital/galaxychain-chain/utils"
	"github.com/galaxy-digital/galaxychain-chain/vecmt"
)
...
var (
	...
	RPCGlobalGasCapFlag = cli.Uint64Flag{
		Name:  "rpc.gascap",
		Usage: "Sets a cap on gas that can be used in glxy_call/estimateGas (0=infinite)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCGasCap,
	}
	RPCGlobalTxFeeCapFlag = cli.Float64Flag{
		Name:  "rpc.txfeecap",
		Usage: "Sets a cap on transaction fee (in GLXY) that can be sent via the RPC APIs (0 = no cap)",
		Value: gossip.DefaultConfig(cachescale.Identity).RPCTxFeeCap,
	}

	AllowedGalaxyGenesisHashes = map[uint64]hash.Hash{
		galaxy.MainNetworkID: hash.HexToHash("0xb0fa5cb0660348eb30a64994e1f5155ff06ab59a447ec1c9d46e6aec8a50c2c4"), // real 0xa97be35f423207258c18624416d67950933456c9a549585b9517c2d81c42a0ce
		galaxy.TestNetworkID: hash.HexToHash("0x53cb15cbc89bf011c4d54b10bf4df0fa99b18d2db3c5511769ff35f44e3a3743"), // real 0x0774ccb0a820e486c3f435b805240f0ab8ceb79bf19af9617b548a28ce6ff9d2
	}
)
...
func getGalaxyGenesis(ctx *cli.Context) integration.InputGenesis {
	...
	case ctx.GlobalIsSet(FakeNetFlag.Name):
		...
		fakeGenesisStore := makegenesis.FakeGenesisStore(num, futils.ToGlxy(10000000000), futils.ToGlxy(5000000))
...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "eth", "glxy", "dag", "sfc", "abft", "web3")
	cfg.WSModules = append(cfg.WSModules, "eth", "glxy", "dag", "sfc", "abft", "web3")
